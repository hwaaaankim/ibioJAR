function createString(i){
	...
	+ '<input type="text" class="form-control" name="noneChangeOptionName" placeholder="가격 변동이 없는옵션 제목을 입력 해 주세요.">'
	+ '</div></div></div></div>'
	+ '<div class="col-lg-5 col-sm-12">'
	+ '<div class="card-body">'
	+ '<div class="hstack gap-1 align-items-start">'
	+ '<div class="flex-grow-1">'
	+ '<input class="form-control" name="noneChangeOptionValues" data-choices-'
	+ i
