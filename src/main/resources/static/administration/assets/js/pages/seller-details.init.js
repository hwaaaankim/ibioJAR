    ...
    columns: [
        ...
        formatter: function (e) {
          return gridjs.html(
            '<div class="d-flex align-items-center"><div class="flex-shrink-0 me-3"><div class="avatar-sm bg-light rounded p-1"><img src="/administration/assets/images/products/' +
              e[0] +
              '" alt="" class="img-fluid d-block"></div></div><div class="flex-grow-1"><h5 class="fs-14 mb-1"><a href="/admin/memberPaymentManagerDetail" class="text-body">' +
              e[1] +
      ...
      { 
          ...
          return gridjs.html(
              ...
              '<div class="d-flex align-items-center"><div class="flex-grow-1"><h5 class="fs-14 mb-1"><a href="/admin/memberPaymentManagerDetail" class="text-body">' +
               e +
              '</a></h5></div></div>' 
          );
        },},
