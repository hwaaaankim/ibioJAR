...
(xhttp.onload = function () {
  ...
  Array.from(e).forEach(function (e) {
    ...
    Array.from(t).forEach((e, t) => {
      ...
      contactList.add({
        ...
        name:
          '<div class="d-flex align-items-center"><div class="flex-shrink-0"></div><div class="flex-grow-1 ms-2 name">' +
          e.name[1] +
          "</div>            </div>",
  ...
  xhttp.open("GET", "/administration/assets/json/contact-list.json"),
  xhttp.send(),
...
function clearFields() {
  (customerImg.src = "/administration/assets/images/users/user-dummy-img.jpg"),
